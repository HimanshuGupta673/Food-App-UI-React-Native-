...
export default function Hotels(props) {
    const restaurent = props.restaurants
    ...
    >
      ...
      >
        ...
        <View style={styles.rightContainer}>
          ...
          <Icons name="star" size={15} color="white" />
        </View>
      </View>
      <View
        style={{
      ...
      <View style={styles.time}>
        <Icons name="clock-o" size={15} color="green" />
        <Text style={{ marginLeft: 3, fontSize: 12 ,color:'grey'}}>{restaurent.time}</Text>
      </View>
